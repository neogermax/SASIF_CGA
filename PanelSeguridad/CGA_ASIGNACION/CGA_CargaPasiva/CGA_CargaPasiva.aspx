<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CGA_ASIGNACION/Sasif_menu.Master"
    CodeBehind="CGA_CargaPasiva.aspx.vb" Inherits="PanelSeguridad.CGA_CargaPasiva" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="../../SasifMaster.js" type="text/javascript"></script>
    <script src="../SasifMaster_Cosult.js" type="text/javascript"></script>
    <script src="CGA_CargaPasiva.js" type="text/javascript"></script>
    <script src="CGA_CargaPasivaTrasaccionsAjax.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <div id="#Marco_CP" style="margin-top: 10px;">
        ...
        <div id="Marco_trabajo_Form">
            <div id="Container_controls">
                <table id="TablaConsulta">
                    ...
                    <tr>
                        <td colspan="4">
                            <div id="container_TCargaPasiva">
                            </div>
                        </td>
                    </tr>
                </table>
                <table id="TablaDatos_CP">
                    <tr>
                        <td id="Td10" style="width: 130px;">
                            Departamento
                        </td>
                        <td style="width: 185px;">
                            <select id="DDLSolicitud">
                            </select>
                    ...
                    <tr>
                        ...
                        <td id="TD_THorasPlan">
                            <input type="text" id="TxtHorasPlan" title="horas" maxlength="4" class="solo-numero" />
                        ...
                        <td id="TD_TNOfertas">
                            <input type="text" id="TxtNOfertas" maxlength="4" title="Descripción" class="solo-numero" />
                        ...
                        <td id="TD_TOrden">
                            <input type="text" id="TxtOrden" maxlength="8" title="Descripción" class="solo-numero" />
