    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            switch (result) {
                ...
                case "Exist_O":
                    $("#dialog").dialog("option", "title", "Integridad referencial");
                    $("#Mensaje_alert").text("No se elimino el Festivo, para eliminarlo debe eliminar primero el registro en la tabla Operario");
                    $("#dialog").dialog("open");
                    $("#DE").css("display", "none");
                    $("#SE").css("display", "none");
                    $("#WE").css("display", "block");
                ...
                case "Exist_All":
                    $("#dialog").dialog("option", "title", "Integridad referencial");
                    $("#Mensaje_alert").text("No se elimino el Festivo, para eliminarlo debe eliminar primero el registro en la tabla Operario y en la tabla Maquina");
                    $("#dialog").dialog("open");
                    $("#DE").css("display", "none");
                    $("#SE").css("display", "none");
                    $("#WE").css("display", "block");
