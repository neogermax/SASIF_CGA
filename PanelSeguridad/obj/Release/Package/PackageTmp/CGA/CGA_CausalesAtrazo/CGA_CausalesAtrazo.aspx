<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CGA/Sasif_menu.Master"
    CodeBehind="CGA_CausalesAtrazo.aspx.vb" Inherits="PanelSeguridad.CGA_CausalesAtrazo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="../../SasifMaster.js" type="text/javascript"></script>
    <script src="../SasifMaster_Cosult.js" type="text/javascript"></script>
    <script src="CGA_CausalesAtrazo.js" type="text/javascript"></script>
    <script src="CGA_CausalesAtrazoTrasaccionsAjax.js" type="text/javascript"></script>
        ...
        <div id="Marco_trabajo_Form">
            <div id="Container_controls">
                <table id="TablaConsulta">
                    ...
                    <tr>
                        <td colspan="4">
                            <div id="container_TCausalesAtrazo">
                            </div>
                        </td>
                    </tr>
                </table>
                <table id="TablaDatos">
                    <tr>
                        ...
                        <td id="TD_Tdescrip">
                            <input type="text" id="TxtDescription" maxlength="90" title="Descripción" />
                    ...
                    <tr>
                        ...
                        <td id="TD_Tarea">
                            <input type="text" id="TxtArea" title="Area/Proceso Responsable" maxlength="50" />
                        ...
                        <td id="TD_Tgerencia">
                            <input type="text" id="TxtGerencia" maxlength="40" title="Gerencia Responsable" />
                    ...
                    <tr>
                        ...
                        <td id="TD9" colspan="3">
                            <input type="text" id="TxtComentario" title="Observacion" maxlength="120" />
                        </td>
                    </tr>
                    <tr>
