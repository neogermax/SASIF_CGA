...
function Tabla_eliminar() {
    var html_TTurnos = "<table id='TTurnos' border='1' cellpadding='1' cellspacing='1'  style='width: 100%'><thead><tr><th>Eliminar</th><th>Codigo</th><th>Descripción</th><th>Hora de Inicio<</th><th>Tiempo</th></tr></thead><tbody>";
...
function Tabla_modificar() {
    var html_TTurnos = "<table id='TTurnos' border='1' cellpadding='1' cellspacing='1'  style='width: 100%'><thead><tr><th>Editar</th><th>Codigo</th><th>Descripción</th><th>Hora de Inicio</th><th>Tiempo</th></tr></thead><tbody>";
    for (itemArray in ArrayTurnos) {
        if (ArrayTurnos[itemArray].Turno_ID != 0) {
...
function Tabla_consulta() {
    var html_TTurnos = "<table id='TTurnos' border='1' cellpadding='1' cellspacing='1'  style='width: 100%'><thead><tr><th>Codigo</th><th>Descripción</th><th>Hora de Inicio</th><th>Tiempo</th></tr></thead><tbody>";
    for (itemArray in ArrayTurnos) {
        if (ArrayTurnos[itemArray].Turno_ID != 0) {
