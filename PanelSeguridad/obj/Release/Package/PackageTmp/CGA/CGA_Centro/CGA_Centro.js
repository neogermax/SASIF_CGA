...
function Tabla_eliminar() {
    var html_TCentro = "<table id='TCentro' border='1' cellpadding='1' cellspacing='1'  style='width: 100%'><thead><tr><th>Eliminar</th><th>Codigo</th><th>Descripción</th><th>Descripción de la Planta</th></tr></thead><tbody>";
...
function Tabla_modificar() {
    var html_TCentro = "<table id='TCentro' border='1' cellpadding='1' cellspacing='1'  style='width: 100%'><thead><tr><th>Editarr</th><th>Codigo</th><th>Descripción</th><th>Descripción de la Planta</th></tr></thead><tbody>";
    for (itemArray in ArrayCentro) {
        if (ArrayCentro[itemArray].Centro_ID != 0) {
...
function Tabla_consulta() {
    var html_TCentro = "<table id='TCentro' border='1' cellpadding='1' cellspacing='1'  style='width: 100%'><thead><tr><th>Codigo</th><th>Descripción</th><th>Descripción de la Planta</th></tr></thead><tbody>";
    for (itemArray in ArrayCentro) {
        if (ArrayCentro[itemArray].Centro_ID != 0) {
