...
function Tabla_eliminar() {
    var html_TGrpMaqunas = "<table id='TGrpMaqunas' border='1' cellpadding='1' cellspacing='1'  style='width: 100%'><thead><tr><th>Eliminar</th><th>Codigo</th><th>Descripción</th></tr></thead><tbody>";
...
function Tabla_modificar() {
    var html_TGrpMaqunas = "<table id='TGrpMaqunas' border='1' cellpadding='1' cellspacing='1'  style='width: 100%'><thead><tr><th>Editarr</th><th>Codigo</th><th>Descripción</th></tr></thead><tbody>";
    for (itemArray in ArrayGRPMaquinas) {
        if (ArrayGRPMaquinas[itemArray].Maquina_ID != 0) {
...
function Tabla_consulta() {
    var html_TGrpMaqunas = "<table id='TGrpMaqunas' border='1' cellpadding='1' cellspacing='1'  style='width: 100%'><thead><tr><th>Codigo</th><th>Descripción</th></tr></thead><tbody>";
    for (itemArray in ArrayGRPMaquinas) {
        if (ArrayGRPMaquinas[itemArray].Maquina_ID != 0) {
