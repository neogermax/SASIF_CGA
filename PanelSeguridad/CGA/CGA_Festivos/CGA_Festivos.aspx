<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CGA/Sasif_menu.Master"
    CodeBehind="CGA_Festivos.aspx.vb" Inherits="PanelSeguridad.CGA_Festivos" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="../../SasifMaster.js" type="text/javascript"></script>
    <script src="../SasifMaster_Cosult.js" type="text/javascript"></script>
    <script src="CGA_Festivos.js" type="text/javascript"></script>
    <script src="CGA_FestivosTrasaccionsAjax.js" type="text/javascript"></script>
            ...
            <div id="Container_controls">
                ...
                <table id="TablaDatos">
                    <tr>
                        ...
                        <td id="TD_TID">
                            <input type="text" id="Txt_Año" title="Llave Primaria" maxlength="4" />
                        ...
                        <td id="TD_Tdescrip">
                            <span class="cssToolTip">
                                <input type="text" id="Txt_mes_Dia" maxlength="4" title="Descripción" />
                                <span>ejemplo con el primero de enero (0101)</span></span> <span class="cssToolTip">
