    ...
    <body>
        ...
        <div id="marco">
            <table id="TablaContraseña">
                ...
                <tr>
                    <td id="TdPassword">
                        <input id="TxtPassword" title="Digite Contraseña" type="password" name="password" style="width: 80%;" /><img
                            alt="error" title="" style="padding-left: 1em; height: 21px; width: 21px;" id="E1" src="../images/error.png" /><img
                                alt="sucess" title="" style="padding-left: 1em; height: 21px; width: 21px;" id="S1" src="../images/success.png" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td id="TdConfirmPassword">
                        ...
                        <img alt="error" title="" style="padding-left: 1em; height: 21px; width: 21px;" id="E2" src="../images/error.png" />
                        <img alt="sucess" title="" style="padding-left: 1em; height: 21px; width: 21px;" id="S2" src="../images/success.png" />
                    </td>
                </tr>
                <tr>
